...
지켜야 할 것
  ...
  - **조정이 있으면 이전 루틴을 바탕으로 그 방향으로만 바꿉니다.** '더 어렵게' 는 같은 뼈대에서 수행량을 한 단계
    올리거나(세트·반복·시간 10~30%) 더 힘든 동작으로, '더 쉽게' 는 내리거나 부담 적은 동작으로 바꿉니다.
    목적과 다루는 요인은 그대로 두고, 무엇을 어떻게 바꿨는지 '왜' 첫 줄에 씁니다.
