...
| 값 | 없음 | **1회 500원** (미리 충전) · 시연 기간에는 하루 3회 무료 |
| 키 없을 때 | 그대로 동작 | 잠김 |
...
AI 루틴 하루 5회(조정 포함) · 자세히 보기 포함 · 약봉지 사진 하루 5회 · 커뮤니티 쓰기 제한 해제(글 하루 30개 · 사진 6장 ·
본문 3,000자). 구독은 이용권을 거치지 않고 상품으로 결제합니다 — 선결제 보너스로 구독을 싸게 사는 길이 생기지 않게.
...
- 환불을 부를 화면(버튼)이 아직 없습니다. API 만 있습니다.
